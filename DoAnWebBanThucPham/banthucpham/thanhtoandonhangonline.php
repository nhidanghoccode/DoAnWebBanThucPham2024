...
error_log("Customer ID: $cus_idd, Final Amount: $finalAmount");
...
if (isset($_GET['orderid']) && $_GET['orderid'] == 'order') {
    ...
    if ($inseorder) {
        echo "Đơn hàng được tạo thành công!";
            ...
            <div class="row g-5" style="margin-top: 50px;">
                ...
                <div class="col-md-12 col-lg-6 col-xl-7" style="border: 1px solid #81c408; padding:10px ;border-radius: 20px;margin-right: 20px;">
                    <div class="table-responsive">
                        ...
                        <form action="thanhtoanQR.php" method="post">
                            <input type="hidden" name="final_amount" value="<?php echo $tongTien; ?>">
                            <input type="hidden" name="cus_idd" value="<?php echo Session::get('curtomer_id'); ?>">
                            <button type="submit" class="btn btn-success">Thanh toán qua mã QR</button>
                        </form>
                    </div>
                                    </td>
                                </tr>
